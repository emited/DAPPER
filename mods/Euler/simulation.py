...
simNo    = 1000  # start ID
showGui  = False
basePath = '/home/debezenac/projects/DAPPER/mods/Euler/uni/'
npSeedstr   = "-1"
...
while t < steps+offset:
	# print('timestep', sm.timestep, 'dx', vel.getDx())
	curt = t * sm.timestep
	...
	# print('before pressure vel', vel.getMin(), vel.getMax())
	# print('vel', [(name, type(v)) for  name, v in vel.__dict__.items()])
	...
	# print('after pressure vel', vel.getMin(), vel.getMax())
	setWallBcs(flags=flags, vel=vel)
